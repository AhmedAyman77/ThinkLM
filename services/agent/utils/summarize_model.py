...
finetuned_tokenizer = AutoTokenizer.from_pretrained(settings.FINETUNED_SUMMARIZE_MODEL_ID)
finetuned_model = AutoModelForCausalLM.from_pretrained(
    settings.FINETUNED_SUMMARIZE_MODEL_ID,
    torch_dtype="auto",
    device_map="auto"
)

print(f"Summarize model loaded from {settings.FINETUNED_SUMMARIZE_MODEL_ID}")
